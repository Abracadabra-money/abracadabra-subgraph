import { ETH_NETWORK, DEGENBOX_ADDRESS_MAINNET, AVALANCHE_NETWORK, DEGENBOX_ADDRESS_AVALANCHE, ARB_NETWORK, DEGENBOX_ADDRESS_ARBITRUM, FTM_NETWORK, DEGENBOX_ADDRESS_FANTOM, BSC_NETWORK, DEGENBOX_ADDRESS_BSC } from "../constants";
