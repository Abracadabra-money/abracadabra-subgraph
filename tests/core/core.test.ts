...
import { MASTER_CONTRACT_ADDRESS, DATA, CLONE_ADDRESS, COLLATERAL_ADDRESS, BORROW_OPENING_FEE, LIQUIDATION_MULTIPLIER, COLLATERIZATION_RATE, COLLATERAL_DECIMALS, COLLATERAL_NAME, COLLATERAL_SYMBOL, INTEREST_PER_SECOND, ORACLE_ADDRESS, ORACLE_DATA } from "./constants";
